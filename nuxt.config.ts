  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { name: 'keywords', content: 'lytexmedia, lytex, media, lytexnet, lytex.net, _lytex_, linkleap, linkspot, webseiten erstellen, webseiten, lytex media, coffee, kaffee' },
        ...
        { name: 'description', content: 'lytexmedia konvertiert Kaffee mit seinem Koffein in hochwertigen Code & Software! Wir sind das Team hinter LinkLeap.' },
        ...
        { name: 'twitter:description', content: 'lytexmedia konvertiert Kaffee mit seinem Koffein in hochwertigen Code & Software! Wir sind das Team hinter LinkLeap.' },
        { property: 'og:title', content: 'lytexmedia' },
        { property: 'og:description', content: 'lytexmedia konvertiert Kaffee mit seinem Koffein in hochwertigen Code & Software! Wir sind das Team hinter LinkLeap.' },
